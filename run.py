...
if len(sys.argv)>1 and (sys.argv[1] == 'train' or sys.argv[1] == 'extratrain'):
    ...
    #(self,               embed_size, hidden_size, sourceWord2ind, targetWord2ind, unkToken, padToken, endToken, dropout)
    nmt = model.NMTmodel(embed_size, hidden_size, sourceWord2ind, targetWord2ind, startToken,  unkToken, padToken, endToken, dropout, linearDropout).to(device)
